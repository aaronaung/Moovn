...
export class FacebookGraphAPIClient {
  private BASE_URL = "https://graph.facebook.com/v20.0";

  constructor(
    private readonly token: FacebookAPIToken,
  ...
  async exchangeCodeForAccessToken(code: string, redirectUri: string) {
    ...
    tokenExchangeUrl.searchParams.set("client_id", this.appId);
    tokenExchangeUrl.searchParams.set("client_secret", this.appSecret);
